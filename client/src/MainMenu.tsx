...
import CareerMenu from './pages/career/CareerMenu.tsx';
import OnlinePortal from './pages/online/index.ts';
import PractiseMenu from './pages/training/menus/PractiseMenu.tsx';
import SettingsMenu from './settings/menus/SettingsMenu';
import DifficultyMenu from './pages/training/menus/DifficultyMenu.tsx';
import TimeSelectionMenu from './pages/training/menus/TimeSelectionMenu.tsx';
import ScoreSelectionMenu from './pages/training/menus/ScoreSelectionMenu.tsx';
import ReplayBrowser from './pages/replay/components/ReplayBrowser.ts';
import ArcadeMenu from './pages/arcade/index.tsx';
