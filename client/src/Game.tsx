...
const Game = () => {
  ...
  }, [fallingLetters, health, combo, complexity]);
    ...
    <>
      ...
      {health <= 0 && (
        <div style={{ 
          ...
          GAME OVER
          <div style={{ fontSize: '0.3em', margin: '15px 0', color: '#ccc' }}>
            Final Score: {Math.floor(score)} | Max Combo: {combo} | Complexity: {complexity}
          </div>
          <button 
            onClick={() => {
              setScore(0);
