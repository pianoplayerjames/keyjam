...
export const Footer: React.FC = () => {
  ...
  const footerLinks = {
    ...
    community: [
      { label: 'Discord Server', path: 'https://discord.gg/keyjam', external: true },
      { label: 'Reddit Community', path: 'https://reddit.com/r/keyjam', external: true },
      { label: 'YouTube Channel', path: 'https://youtube.com/keyjam', external: true },
      { label: 'Twitter', path: 'https://twitter.com/keyjam', external: true }
    ],
    support: [
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                {[
                  { icon: '💬', label: 'Discord', url: 'https://discord.gg/keyjam' },
                  { icon: '🐦', label: 'Twitter', url: 'https://twitter.com/keyjam' },
                  { icon: '📺', label: 'YouTube', url: 'https://youtube.com/keyjam' },
